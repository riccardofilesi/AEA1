...
The ECB is one of the main player in the Eurosystem. During the last financial crisis, it had the hard task to preserve the existence of a single currency in the Eurozone, 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbODIzNTU0OTEwXX0=
-->