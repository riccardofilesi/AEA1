...
# Method
As suggested by [Mehic (2017)](http://lup.lub.lu.se/luur/download?func=downloadFile&recordOId=8904917&fileOId=8906382). Income inequality regression models with applications.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMzIzMjA4MF19
-->