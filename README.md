...
globalization is associated with lower income inequality (ibid.). Hence, I first run run the following regression, including a first and second lag of the dependent variable to solve 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc5NzE5NjAzMV19
-->