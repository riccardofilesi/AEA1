...
$$Gini_t = \alpha + \beta_1 Gini_{t-1} + \beta_2 Gini_{t-2} + \beta_3 \frac{Credit_{t}}{GDP_t}  + \beta_4 \frac{FDI_{t}}{GDP_t}  + \beta_5 Industrial Share_{t} + \beta_6 Credit_{t}  $$
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5MzUyNDAzM119
-->